...
function MyVerticallyCenteredModal(props: any) {
  return (
    <Modal {...props} size="lg" aria-labelledby="contained-modal-title-vcenter" centered className={styles.modalBox}>
...
const HomePopUp = (props: any) => {
  ...
  return (
    <>
      {compData && <MyVerticallyCenteredModal show={modalShow} onHide={() => setModalShow(false)} image={compData} />}
    </>
  );
};
