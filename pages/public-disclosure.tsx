...
const MandatoryPublicDisclosurePage: NextPage<IPage> = (props) => {
...
export default MandatoryPublicDisclosurePage;

export const getServerSideProps: GetServerSideProps = async () => {
  try {
    const res = await getAPI(ENDPOINT.SSR.mandatoryPublicDisclosurePage);
